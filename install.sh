...
install_XrayR() {
    ...
    file="https://github.com/XrayR-project/XrayR-script/raw/master/XrayR.service"
    ...
    curl -o /usr/bin/XrayR -Ls https://raw.githubusercontent.com/XrayR-project/XrayR-script/master/XrayR.sh
